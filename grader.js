...
var URL_DEFAULT = "http://murmuring-river-2284.herokuapp.com";
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <check_url>', 'Path to url', clone(assertUrlExists), URL_DEFAULT)
        .parse(process.argv);

    //console.log("-url passed in: " + program.url);
